...
<Info>
  To confirm bank transfer on sandbox, use this endpoint
    ...
    `https://adapter.cepta.co/api/v1/pay/simulate-payment?TransactionRef=exampleRef`.  Use the [confirm transaction](/product/charge-api/confirm-transaction) in production.
</Info>
